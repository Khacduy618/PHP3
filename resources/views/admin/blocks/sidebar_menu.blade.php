    ...
    <div class="navbar-wrapper">
        ...
        <div class="navbar-content">
            <ul class="pc-navbar">
                ...
                <li class="pc-item pc-hasmenu">
                    <a href="#" class="pc-link"><span class="pc-micon"><i class="ti ti-menu"></i></span><span
                            class="pc-mtext">Quản trị loại tin</span><span class="pc-arrow"><i
                                data-feather="chevron-right"></i></span></a>
                    <ul class="pc-submenu">
                        <li class="pc-item"><a class="pc-link" href="{{ route('admin.category.create') }}">Tạo loại tin
                                mới</a>
                        </li>
                        <li class="pc-item"><a class="pc-link" href="{{ route('admin.category.list') }}">Danh sách loại
                                tin</a>
                        </li>
                ...
                <li class="pc-item pc-hasmenu">
                    <a href="#!" class="pc-link"><span class="pc-micon"><i class="ti ti-news"></i></span><span
                            class="pc-mtext">Quản trị tin tức</span><span class="pc-arrow"><i
                                data-feather="chevron-right"></i></span></a>
                    <ul class="pc-submenu">
                        <li class="pc-item"><a class="pc-link" href="{{ route('admin.news.create') }}">Tạo tin mới</a>
                        </li>
                        <li class="pc-item"><a class="pc-link" href="{{ route('admin.news.list') }}">Danh sách tin</a>
                        </li>
            ...
            <!-- <div class="card text-center">
                <div class="card-body">
                    <img src="admin/assets/images/img-navbar-card.png" alt="images" class="img-fluid mb-2">
